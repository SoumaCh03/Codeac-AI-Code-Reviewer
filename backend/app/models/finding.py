...
class Finding(Base):
    ...
    category: Mapped[str] = mapped_column(String) # security, performance, maintainability, bug
    ...
    status: Mapped[str] = mapped_column(String, default="open") # open, resolved, false_positive
